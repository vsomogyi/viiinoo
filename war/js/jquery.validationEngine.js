 ...
 * 
 * Changes by PTihomir
 * - _parseDate method now accepts just years also
 * - when first error is founded we finish checking and show the error message
 * 
 * 
 */
(function($) {
    ...
    var methods = {
        ...
        */
        ...
        _parseDate: function(d) {
            ...
            if(dateParts==d)
                dateParts = d.split("/");
            var zeroYear = new Date(0);
            zeroYear.setFullYear(dateParts[0]);
            if (dateParts[1] && dateParts[2]) {
            	zeroYear.setMonth(dateParts[1] - 1);
            	zeroYear.setDate(dateParts[2]);
            }
            return zeroYear;
        },
        /**
